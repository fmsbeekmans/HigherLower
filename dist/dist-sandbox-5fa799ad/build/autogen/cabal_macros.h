...
/* package higherLower-0.1.0.0 */
#define VERSION_higherLower "0.1.0.0"
#define MIN_VERSION_higherLower(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "higherLower-0.1.0.0"

#define CURRENT_PACKAGE_KEY "higherLower-0.1.0.0"
